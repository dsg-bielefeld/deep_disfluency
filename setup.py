...
def recurse(package_name, directory):
    paths = []

    dir_path = os.path.join(package_name, directory)
...
setup(
    ...
    description='Deep Learning systems for training and testing disfluency detection and related tasks on speech data.',  # Optional
    ...
    url='https://github.com/dsg-bielefeld/deep_disfluency',  # Optional
    ...
    #
    # For a list of valid classifiers, see HTTP://pypi.org/classifiers/
    ...
    keywords='disfluency detection utterance segmentation deep machine learning',  # Optional
